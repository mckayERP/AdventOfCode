...
public class PointState implements Cloneable
{
    ...
    final LinkedList<String> keySequence;

    public PointState(Position p, Direction dir, Integer costOfThisMove, Integer costOfThisPath, LinkedList<Position> path, LinkedList<String> keySequence)
    {
